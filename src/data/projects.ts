...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: 'AIC Museum Experience',
    subtitle: 'Reimagining the Art Institute of Chicago for Gen Z visitors',
    description:
      'A research-grounded group project exploring how the Art Institute of Chicago could better engage Gen Z through a mobile companion app. Conducted 12 user interviews, mapped the visitor emotional journey, and designed a Figma prototype from research through concept.',
    problem:
    ...
    sections: [
      {
        id: 'overview',
        title: 'Overview',
        body: 'An academic group project completed for UXD 260: Research and Evaluation at DePaul University, Spring 2025. The team — Damir, Chris, Ryan, Andrew, and Omar — investigated how the Art Institute of Chicago could better serve Gen Z visitors through user research, journey mapping, and a Figma concept prototype.\n\nThis project does not represent a client relationship with the Art Institute of Chicago. All work is speculative and completed for academic purposes.',
      },
      {
        id: 'challenge',
        title: 'The Challenge',
        ...
        images: ['/Portfolio/projects/aic-museum-experience/deck-01.jpg'],
        imageLayout: 'single',
      },
      {
        id: 'research',
        title: 'Research Approach',
        body: 'We conducted 12 semi-structured interviews with participants aged 18–25, focusing on their last museum visit — what they found engaging or frustrating and how technology fits into their cultural experiences. Participants were recruited from the DePaul community and screened for having visited a museum within the past year.\n\nResearch methods included semi-structured interviews, affinity mapping, a visitor emotional journey map, and behavioral insight synthesis across the team.',
        images: [
      ...
      },
      {
        id: 'key-insights',
        title: 'Key Insights',
        body: 'Six findings emerged consistently across interviews and shaped every design decision that followed.',
        ...
        items: [
          ...
          'Social Friction — Coordinating a group visit was difficult. Scheduling, ticket purchasing, and navigating together each added friction that made people less likely to go.',
          'Cost Concern — Ticket prices created hesitation, especially around repeat visits. Participants wanted to feel the experience was worth their money.',
          ...
          'Tech is Welcome — All 12 participants said they would use a museum companion app if it genuinely improved the visit. They were not opposed to technology in cultural spaces.',
          'Social Discovery — People discovered exhibits through TikTok, Instagram, and peer recommendations far more than through the museum\'s own channels.',
        ],
      },
      {
        id: 'visitor-journey',
        title: 'Visitor Journey',
        body: 'We mapped the emotional arc of a Gen Z museum visit across five phases: Discovery, Planning, Arrival, Engagement, and Exit. The map revealed two consistent low points — Planning (frustrating: checking prices, coordinating schedules, feeling overwhelmed) and Arrival (frustrating: finding parking, navigating an unfamiliar space, energy dropping before the experience begins).\n\nEngagement and Exit were neutral rather than positive. Visitors walked through exhibits, took photos and short videos, then left the museum feeling uninspired and unsure if the time and money was well spent.',
        images: [
      ...
      },
      {
        ...
        body: 'The concept organizes the companion app around three moments in the visitor journey: entering, engaging, and exiting the museum.\n\nEnter — QR-based check-in removes ticketing friction and surfaces a personalized visit plan based on available time and interests.\n\nEngage — In-gallery features let visitors interact with exhibits through their phone: artist context, audio, and curated exhibit details surfaced at the right moment.\n\nExit — A speculative digital collecting layer — explored as one possible engagement model in this project — lets visitors claim a digital memento tied to exhibits they visited, as an interactive extension of the experience beyond the building.',
        images: ['/Portfolio/projects/aic-museum-experience/deck-08.jpg'],
        imageLayout: 'single',
      },
      {
      ...
      },
      {
        ...
        body: 'The exhibit identity concept is built around the tagline "Own the moment. Experience the future of art." — positioning the museum visit as something active and memorable rather than passive and forgettable. The visual language of the concept uses bold typography, high contrast, and photography-forward layouts to reflect the energy of the target audience while staying consistent with the Art Institute brand.\n\nThe Figma prototype covers onboarding, a home feed with upcoming events and curated collections, an events market, a rewards system, and exhibit-level detail screens.',
      ...
      },
      {
        ...
        body: 'The full Figma prototype, covering the visitor flow from first launch through the post-visit experience. Built to demonstrate frictionless onboarding, in-gallery navigation, the events market, and the rewards layer.',
        images: [
        ...
        captions: [
          ...
          'Market — Checkout',
          'Rewards — Overview',
          'Rewards — Earned items',
          'Map — Museum navigation',
          'Map — Exhibit locator',
          'Exhibit — Detail view',
          'Exhibit — Extended detail',
      ...
      },
      {
        id: 'outcome',
        title: 'Outcome',
        body: 'The project delivered a research-grounded concept addressing the core friction points identified in our interviews — the passive gallery experience, social coordination barriers, and the lack of engagement beyond the visit. The Figma prototype was presented as the course final and demonstrated a cohesive mobile experience from onboarding through post-visit.\n\nAs a speculative academic concept, the digital collecting layer was explored as one possible model for reward and repeat engagement — not a proposed product or a claim about museum direction.',
      },
      {
        id: 'reflection',
        title: 'Reflection',
        body: 'Working within a team of five made research synthesis and design decisions require real alignment across different perspectives — which made the process more realistic and more challenging than solo work. The visitor journey mapping was the most valuable exercise: it made the emotional low points concrete and gave the team a shared framework for evaluating every design decision.\n\nIf this project were to continue, the priority would be usability testing on the Figma prototype — specifically validating the onboarding flow and in-gallery navigation experience — and further refining the digital collecting concept with clearer user controls and a simpler explanation for users unfamiliar with the model.',
      },
    ],
  },
  {
